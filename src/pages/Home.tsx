...
function Home() {
  ...
  const [recentLinks, setRecentLinks] = useState<LinkRecord[]>([
    {
      id: '1',
      original: 'https://github.com/batmant/URL-Shortener/tree/main/utils',
    ...
    <div className="app-container">
      ...
      <header className="animate-fade-in">
        ...
        <nav className="nav-links">
          ...
          <Link to="/login" className="btn btn-primary" style={{ padding: '0.5rem 1.25rem', fontSize: '0.85rem', textDecoration: 'none', color: 'white' }}>
            Login
          </Link>
        </nav>
      </header>
      ...
      <main>
        ...
        <p className="hero-subtitle animate-fade-in delay-200">
          A powerful URL shortener built for speed, reliability, and analytics. 
          Transform long, ugly links into clean, trackable URLs.
        </p>
              ...
              {recentLinks.map((link) => (
                <div key={link.id} className="link-card glass-panel">
                  <div className="link-card-left">
                    <p className="link-original" title={link.original}>{link.original}</p>
                    <div className="link-meta">
                      <span>{link.date}</span>
                      <span className="dot">•</span>
                      <span><BarChart3 size={14} /> {link.clicks} clicks</span>
                    </div>
                  </div>
                  <div className="link-card-right">
                    ...
                    <div className="link-card-actions">
                      <button className="icon-btn" onClick={() => copyToClipboard(link.short, false)} title="Copy">
                        <Copy size={16} />
                      </button>
                      <a href={link.short} target="_blank" rel="noreferrer" className="icon-btn" title="Visit">
        ...
        <div className="features-grid animate-fade-in delay-300" style={{ animationDelay: '500ms' }}>
          <div className="feature-card">
            ...
            <p className="feature-desc">
              Experience zero latency redirection globally, powered by edge computing infrastructure.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p className="feature-desc">
              Every link is encrypted and monitored 24/7. We guarantee 99.9% uptime for all your short links.
            </p>
          </div>
